...
#define SIGNAL_HAS_IDF_TASK_CAPS 1
#else
#define SIGNAL_HAS_IDF_TASK_CAPS 0
#endif

#if SIGNAL_HAS_IDF_TASK_CAPS && defined(configSUPPORT_STATIC_ALLOCATION) &&                      \
    (configSUPPORT_STATIC_ALLOCATION == 1) && defined(MALLOC_CAP_SPIRAM)
#define SIGNAL_CAN_USE_EXTERNAL_STACKS 1
#else
#define SIGNAL_CAN_USE_EXTERNAL_STACKS 0
#endif

namespace signal_task_support {
...
#if SIGNAL_CAN_USE_EXTERNAL_STACKS
